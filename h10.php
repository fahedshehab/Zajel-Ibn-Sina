...
{
echo " <form action='h11.php' method='post'>

First_Exam: <input type='text' name='first'/>&nbsp; 

Second_Exam: <input type='text' name='second' />&nbsp; 
Final_Exam: <input type='text' name='final' />&nbsp; 
id_student: <input type='text' name='id2' />&nbsp; 
